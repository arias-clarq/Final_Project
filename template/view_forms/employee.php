<?php
session_start();
$_SESSION['title'] = "View Employee Form";
                ...
                <div class="form-body">
                    <div class="mb-3 mt-3">
                        <div class="input-group">
                            ...
                            <input type="text" value="<?= isset($row['elem']) ? $row['elem'] : "" ?>" class="form-control"
                                placeholder="Enter Elementary" name="elem" readonly>
                            <input type="text" value="<?= isset($row['jhs']) ? $row['jhs'] : "" ?>" class="form-control"
                                placeholder="Enter Junior Highschool" name="jhs" readonly>
                            <input type="text" value="<?= isset($row['shs']) ? $row['shs'] : "" ?>" class="form-control"
                        ...
                        <div class="col d-flex align-items-center justify-content-center">
                            <div class="input-group" style="height: 1.4rem;">
                                ...
                                <input type="text"
                                    ...
                                    class="form-control" placeholder="Enter Employee Id Number" name="employement_num"
                                    readonly>
                            </div>
                        </div>
            ...
            <div class="form-grids row widget-shadow" data-example-id="basic-forms">
                ...
                <div class="form-body">
                    <div class="input-group mb-3 mt-3">
                        ...
                        <input type="text" value="<?= isset($row['phil']) ? $row['phil'] : "" ?>" class="form-control"
                            placeholder="Enter PhilHealth Number" name="phil">
                ...
                <div class="form-body">
                    <div class="row row-col-2 input-group mb-3 mt-3">
                        ...
                        <div class="col input-group">
                            ...
                            <input value="<?= isset($row['relationship']) ? $row['relationship'] : "" ?>" type="text"
                                class="form-control" placeholder="Enter Relationship" name="person_relationship"
                                readonly>
                        </div>
                    </div>
                    <div class="row row-col-2 input-group mb-3 mt-3">
                        ...
                        <div class="col input-group">
                            ...
                            <input value="<?= isset($row['person_email']) ? $row['person_email'] : "" ?>" type="email"
                                class="form-control" placeholder="Enter Spouse/Guardian Email" name="person_email"
                                readonly>
                        </div>
                    </div>
                    <div class="d-flex justify-content-end">
                        <a href="../../dashboard/employee_mgt.php">
                            <button href="../../dashboard/employee_mgt.php" type="submit"
