<aside class="sidebar-left">
    <nav class="navbar navbar-inverse">
        <div class="navbar-header">
            ...
            <h1><a class="navbar-brand" href="../../dashboard/dashboard.php"><span class="fa fa-area-chart"></span> Glance<span
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="../../dashboard/employee_mgt.php"><i class="fa fa-angle-right"></i> Employee</a></li>
                        <li><a href="../../dashboard/customer_mgt.php"><i class="fa fa-angle-right"></i> Customer</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="charts.html">
