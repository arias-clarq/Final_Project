<aside class="sidebar-left">
    <nav class="navbar navbar-inverse">
        <div class="navbar-header">
            ...
            <h1><a class="navbar-brand" href="dashboard.php"><span class="fa fa-area-chart"></span> Glance<span
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="employee_mgt.php"><i class="fa fa-angle-right"></i> Employee</a></li>
